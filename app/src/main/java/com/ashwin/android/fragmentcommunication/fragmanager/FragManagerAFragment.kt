...
private const val SUB_TAG = "FragManagerAFragment"

class FragManagerAFragment : Fragment() {
    companion object {
        @JvmStatic
        fun newInstance() = FragManagerAFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            fragmentCommon.sendButton.setOnClickListener {
                ...
                parentFragmentManager.setFragmentResult("result_from_a", bundle)
            }
        }

        parentFragmentManager.setFragmentResultListener("result_from_b", viewLifecycleOwner, { key, bundle ->
